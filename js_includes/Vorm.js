...
jqueryWidget: {
    _init: function () {
        ...
        this.html6 = dget(this.options, "html6");
        ...
        var dom = htmlCodeToDOM(this.html6, function (dom) {
            HAS_LOADED = true;
        ...
        if (this.continueMessage) {
                    ...
                    this.$button.text("");
                    this.element.append((this.$button).append($("<a>").attr('href', '').text("Continue")
...
properties: {
    ...
    htmlDescription: function (opts) {
        return htmlCodeToDOM(opts.html6);
    }
}
});
