...
jqueryWidget: {
    _init: function () {
        ...
        this.$html3 = htmlCodeToDOM(this.html3);
        this.element.append($("<div>").addClass(this.cssPrefix + 'html3').append(this.$html3));
    ...
    handleBarClick: function (e) {
        ...
        if (! clickedBar) {
            ...
            this.finishedCallback([[
                     ["html3", csv_url_encode(this.$html3.innerHTML)],
...
properties: {
    obligatory: ["html3", "startValue", "endValue"],
    htmlDescription: function(opts) {
        return $(document.createElement("div")).text(opts.html3 || "");
    }
}
});
