...
jqueryWidget: {
    _init: function () {
        ...
        this.$html4 = htmlCodeToDOM(this.html4);
        this.element.append($("<div>").addClass(this.cssPrefix + 'html4').append(this.$html4));
    ...
    handleBarClick: function (e) {
        ...
        if (! clickedBar) {
            ...
            this.finishedCallback([[
                     ["html4", csv_url_encode(this.$html4.innerHTML)],
...
properties: {
    obligatory: ["html4", "startValue", "endValue"],
    htmlDescription: function(opts) {
        return $(document.createElement("div")).text(opts.html4 || "");
    }
}
});
