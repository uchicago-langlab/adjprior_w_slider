...
jqueryWidget: {
    _init: function () {
        ...
        this.$html5 = htmlCodeToDOM(this.html5);
        this.element.append($("<div>").addClass(this.cssPrefix + 'html5').append(this.$html5));
    ...
    handleBarClick: function (e) {
        ...
        if (! clickedBar) {
            ...
            this.finishedCallback([[
                   ["html5", csv_url_encode(this.$html5.innerHTML)],
...
properties: {
    obligatory: ["html5", "startValue", "endValue"],
    htmlDescription: function(opts) {
        return $(document.createElement("div")).text(opts.html5 || "");
    }
}
});
